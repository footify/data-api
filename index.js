module.exports = {
    ...
    leagueModel: require('./lib/league/league.model.js'),
    leagueRepository: require('./lib/league/league.repository.js'),
    leagueRankingModel: require('./lib/league/league_ranking.model.js'),
    leagueRankingRepository: require('./lib/league/league_ranking.repository.js'),
    ...
    friendListModel: require('./lib/friendList/friendList.model'),
    friendListRepository: require('./lib/friendList/friendList.repository'),
